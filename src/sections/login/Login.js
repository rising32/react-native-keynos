...
class Login extends Component {
  constructor(props) {
    ...
    if(value != "" && !Utils.mailValidate(value)){
      this.setState({emailNeedCorrection: true, emailIncorrect: true, emailErrorLabel: "Introduzca un correo válido"})
  ...
  onChangePassword(value) {
    ...
    if(value != "" && !Utils.passwordValidate(value)){
      this.setState({passwordNeedCorrection: true, passwordIncorrect: true, passwordErrorLabel: "Debe tener al menos 8 caracteres"})
